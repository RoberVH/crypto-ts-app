import { TriviasType } from '../types/triviaTypes'
export const Trivias: TriviasType = [
  ...
  {
    name: 'Inventos y Descubrimientos',
    items: [
      {
      ...
      {
        question:
          '¿Cuál de estos científicos desarrolló la teoría de la relatividad?',
        options: [
